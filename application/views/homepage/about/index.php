					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="philosophy" role="tabpanel" aria-labelledby="home-tab">
							<div class="row">
								...
								<div class="col-md-6">
									<img class="img-fluid rounded shadow " src="<?=home_assets()?>images/company/company-image.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="mission" role="tabpanel" aria-labelledby="profile-tab">
							<div class="row">
								...
								<div class="col-md-6">
									<img class="img-fluid rounded shadow mt-20" src="<?=home_assets()?>images/company/company-image-2.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="vision" role="tabpanel" aria-labelledby="contact-tab">
							<div class="row">
								...
								<div class="col-md-6">
									<img class="img-fluid rounded shadow mt-20" src="<?=home_assets()?>images/company/company-image-3.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="<?=home_assets()?>images/team/member-1.jpg" alt="team people">
						<!-- /member photo -->
					</div>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="<?=home_assets()?>images/team/member-2.jpg" alt="team people">
						<!-- /member photo -->
					</div>
					<!-- member name & designation -->
					<div class="member-content">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="<?=home_assets()?>images/team/member-3.jpg" alt="team people">
						<!-- /member photo -->
			...
			<div class="col-lg-3 col-sm-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="<?=home_assets()?>images/team/member-4.jpg" alt="team people">
						<!-- /member photo -->
					</div>
