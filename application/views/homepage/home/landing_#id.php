		...
		<div class="row">
			<div class="col-lg-6 mb-4 mb-lg-0">
				<div class="video-player">
					<img class="img-fluid rounded w-100" src="<?=home_assets()?>images/slider/video-player-thumb.jpg" alt="">
					<a class="play-icon" href="<?=home_assets()?>javascript:void(0)">
				...
				<div class="block">
					...
					<ul class="list-inline wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".7s">
						<li class="list-inline-item">
							<a href="<?=home_assets()?>https://themefisher.com/" target="_blank" class="btn btn-main">Download More</a>		
						</li>
					</ul>
				</div>
			</div>
